...
from vissl.data.dense_ssl_dataset import DenseSSLDataset
...
def build_dataset(cfg, split, **kwargs):
    ...
    """
    dataset = cfg.DATA.TRAIN.DATASET_TYPE
    if dataset == 'dense_ssl_dataset':
        return DenseSSLDataset(
            cfg=cfg,
            split=split,
            dataset_source_map=DATASET_SOURCE_MAP,
            data_sources_with_subset=DATA_SOURCES_WITH_SUBSET_SUPPORT,
        )
    elif dataset == 'generic_ssl_dataset':
