...
from vissl.hooks.dense_swav_hooks import DenseNormalizePrototypesHook
from vissl.hooks.dense_swav_hooks import DenseSwAVUpdateQueueScoresHook
...
def default_hook_generator(cfg: AttrDict) -> List[ClassyHook]:
    ...
    if cfg.LOSS.name == "dense_swav_loss":
        hooks.extend([DenseSwAVUpdateQueueScoresHook(), DenseNormalizePrototypesHook()])
